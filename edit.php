...
<form action="update.php" method="POST">
  ...
  <?php
    ...
    echo"<input type='text' placeholder='Company' name='company' value='{$row['company']}' required>";
    echo"<input type='text' placeholder='Position' name='position' value='{$row['position']}' required>";
